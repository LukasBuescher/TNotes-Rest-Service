...
public class MockDataGenerator {
    public static CommandLineRunner generate(ExerciseRepository exerciseRepository, DayRepository dayRepository, RoutineRepository routineRepository, TrainingSetRepository trainingSetRepository){
        return (args) -> {
